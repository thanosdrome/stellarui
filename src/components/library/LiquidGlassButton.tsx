...
const VARIANT: Record<NonNullable<LiquidGlassButtonProps['variant']>, string> = {
  ...
  secondary: 'bg-white/[0.04] border-white/10 text-zinc-100',
...
export const LiquidGlassButton: React.FC<LiquidGlassButtonProps> = ({
  ...
  return (
    <motion.button
      ...
      className={`
        group relative isolate overflow-hidden rounded-full border font-medium
    ...
    >
      ...
      <span className="pointer-events-none absolute inset-0 rounded-full bg-gradient-to-r from-transparent via-white/25 to-transparent -translate-x-[150%] transition-transform duration-700 ease-out group-hover:translate-x-[150%]" />
